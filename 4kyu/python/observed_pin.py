...
# of wrong PINs, they never finally lock the system or sound the alarm. That's
# why we can try out all possible (*) variations.
...
def get_pins(observed):
    ...
    string = "".join([adjacents[int(num)] for num in observed])
    return ["".join(perm) for perm in set(itertools.permutations(string, len(observed)))]
